...
router.get("/user/:id",isAuthenticatedUser, getUser); // Rota para buscar usuário por ID
...
router.get("/user",isAuthenticatedUser, getUserByUsername); // Rota para buscar usuário por nome de usuário
